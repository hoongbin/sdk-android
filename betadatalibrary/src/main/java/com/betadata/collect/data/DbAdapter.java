...
public class DbAdapter {
    private static final String TAG = "BT.DbAdapter";
    ...
    /** App 是否启动到 onResume   app onResume为true,app onPuse 为false*/
    private boolean mAppResumeStart = false;
    ...
    public long getMaxCacheSize(Context context) {
        try {
            return BetaDataAPI.sharedInstance(context).getMaxCacheSize();
        } catch (Exception e) {
    ...
    public int addJSON(JSONObject j) {
        ...
        try {
            if (belowMemThreshold()) {
                BetaDataLog.i(TAG, "There is not enough space left on the device to store events, so will delete some old events");
     ...
     */
    public boolean getAppResumeStart(){
        return mAppResumeStart;
    }
    ...
    public long getAppStartTime(){
        ...
        BetaDataLog.d(TAG,"getAppStartTime:" + startTime);
        return startTime;
    }
    ...
    public long getAppPausedTime(){
        if (System.currentTimeMillis() - mAppPausedTime > BetaDataConfig.mSessionTime) {
            Cursor cursor = null;
            try {
    ...
    public boolean getAppEndState(){
        ...
        BetaDataLog.d(TAG,"getAppEndState:" + mAppEndState);
        return mAppEndState;
    }
    ...
    public String getAppEndData(){
        ...
        BetaDataLog.d(TAG,"getAppEndData:" + data);
        return data;
    }
    ...
    public int getSessionIntervalTime(){
        ...
        mSavedSessionTime = BetaDataConfig.mSessionTime;
        BetaDataLog.d(TAG,"getSessionIntervalTime:" + BetaDataConfig.mSessionTime);
...
//                                    .append(System.currentTimeMillis())
            ...
            BetaDataLog.i(TAG, "Could not pull records for BetaData out of database " + tableName
                    + ". Waiting to send.", e);
            last_id = null;
            data = null;
        } finally {
    ...
    public String[] generateDataString(String tableName) {
        Cursor c = null;
        String data = null;
        String last_id = null;
        try {
            c = contentResolver.query(mDbParams.gemUri(), null, null, null, DbParams.KEY_CREATED_AT );
