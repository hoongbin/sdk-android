...
public class DbParams {
    ...
    private DbParams(String packageName) {
        mUri = Uri.parse("content://" + packageName + ".BetaDataContentProvider/" + TABLE_EVENTS);
        mAppStartUri = Uri.parse("content://" + packageName + ".BetaDataContentProvider/" + TABLE_APPSTARTED);
        mAppStartTimeUri = Uri.parse("content://" + packageName + ".BetaDataContentProvider/" + TABLE_APPSTARTTIME);
        mAppEndStateUri = Uri.parse("content://" + packageName + ".BetaDataContentProvider/" + TABLE_APPENDSTATE);
        mAppEndDataUri = Uri.parse("content://" + packageName + ".BetaDataContentProvider/" + TABLE_APPENDDATA);
        mAppPausedUri = Uri.parse("content://" + packageName + ".BetaDataContentProvider/" + TABLE_APPPAUSEDTIME);
        mSessionTimeUri = Uri.parse("content://" + packageName + ".BetaDataContentProvider/" + TABLE_SESSIONINTERVALTIME);
    }
