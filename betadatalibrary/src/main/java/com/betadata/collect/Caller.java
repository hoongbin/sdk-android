...
class Caller {
    ...
    public Object applyMethodWithArguments(View target, Object[] arguments) {
        ...
        if (mTargetClass.isAssignableFrom(klass)) {
            try {
                ...
                BetaDataLog.i(TAG, "Method " + mTargetMethod.getName() + " appears not to be public", e);
            } catch (final IllegalArgumentException e) {
                BetaDataLog.i(TAG,
                        "Method " + mTargetMethod.getName() + " called with arguments of the wrong type", e);
            } catch (final InvocationTargetException e) {
                BetaDataLog.i(TAG, "Method " + mTargetMethod.getName() + " threw an exception", e);
            }
        }
    ...
    private static final String TAG = "BT.Caller";
}
